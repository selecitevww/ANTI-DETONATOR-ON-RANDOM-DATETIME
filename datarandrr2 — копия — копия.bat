...
IF %var1% GTR %var4% (
    ...
    ECHO %var3% больше %var4%.
) ELSE IF %var3% LSS %var4% (
    ECHO %var3% меньше %var4%.
) ELSE (
    SET /A "NetworkAddress3=0"
    SET /A "NetworkAddress4"="%randomStringg%" 
    ECHO %var4% равно %var4%.
)
...
IF %sar7% GTR %sar7% (
    ...
    ECHO %sar7% больше %sar8%.
) ELSE IF %sar7% LSS %sar8% (
    ECHO %sar7% меньше %sar8%.
) 
set /a "sar9=%NetworkAddres7%%NetworkAddres6%"
SET sar10=59
IF %sar9% GTR %sar10% (
    ECHO %sar9% больше %sar10%.
    ...
    ECHO %sar9% меньше %sar10%.
) 
set /a "sar11=%NetworkAddres5%%NetworkAddress17%"
SET sar12=59
IF %sar11% GTR %sar12% (
    ECHO %sar11% больше %sar12%.
    ...
    ECHO %sar11% меньше %sar12%.
) 
set /a "sar13=%NetworkAddressk%%NetworkAddress16%"
SET sar14=10
IF %sar13% GTR %sar14% (
    ECHO %sar13% больше %sar14%.
    ...
    ECHO %sar13% меньше %sar14%.
) 
ECHO %NetworkAddress1%%NetworkAddress2%-%NetworkAddress3%%NetworkAddress4%-%NetworkAddress5%%NetworkAddress6%%NetworkAddress7%%NetworkAddress8%
set /a "sar1=%NetworkAddress1%%NetworkAddress2%"
SET sar2=30 
IF %sar1% GTR %sar2% (
    ECHO %sar1% больше %sar2%.
